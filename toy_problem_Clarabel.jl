...
function main_Clarabel()
    ...
    time_taken = @elapsed begin
     best_ub, feasible_solution, early_num, total_iter, fea_iter = branch_and_bound_solve(solver, result,n,ϵ, integer_vars,true,true) 
    end
    ...
    best_ub_without, feasible_base_solution_without, early_num_without, total_iter_without, fea_iter_without = branch_and_bound_solve(solver_without, base_solution_without,n,ϵ, integer_vars, true, false) 
