...
with_iter = load("mimpc_iterations_N=2_1to2400.jld","with_iter")
without_iter = load("mimpc_iterations_N=2_1to2400.jld", "without_iter")
first_iter_num = load("mimpc_iterations_N=2_1to2400.jld", "first_iter_num")
with_iter2 = load("mimpc_iterations.jld","with_iter")

println(with_iter[2300:2400])
println(with_iter2==with_iter[2300:2400])
...
xlabel("Intervals")
xlim([0,100])
savefig("mpc_comparison-N=2.pdf")
