...
for i = start_horizon:end_horizon
    ...
    println("s : ", s)  =#
    λ=0.99
    η= 5000 # set to 1000.0 to disable optimise_correction entirely
    ϵ = 1e-8
...
#start bnb loop
    ...
    best_ub, feasible_solution, early_num, total_iter, fea_iter = branch_and_bound_solve(solver, base_solution,n,ϵ, i_idx, true, true, true, λ,η,true,false) 
    ...
    best_ub_without, feasible_base_solution_without, early_num_without, total_iter_without, fea_iter_without = branch_and_bound_solve(solver_without, base_solution_without,n,ϵ, i_idx, true, false, true,λ,η,false,false) 
...
save("mimpc_iterations_N=8_eta=point01.jld", "with_iter", with_iter_num, "without_iter", without_iter_num, "first_iter_num", first_iter_num, "percentage", percentage_iter_reduction)
