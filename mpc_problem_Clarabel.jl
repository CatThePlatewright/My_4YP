...
save("mimpc_iterations_N=8_no_warmstart_no_domprog_selectleaf.jld", "with_iter", with_iter_num, "without_iter", without_iter_num, "first_iter_num", first_iter_num, "percentage", percentage_iter_reduction)
