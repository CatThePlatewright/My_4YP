...
function solve_in_Clarabel(myA,myb,mycones)
    ...
    println("SOLVE IN CLARABEL IS USING ")
    println("WE UPDATED A TO: ", myA)

    println("WE UPDATED B TO: ", myb)

    println("WE UPDATED s TO: ", mycones)
    #println("SOLVER VARS: ", solver.variables)
